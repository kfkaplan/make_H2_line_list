...
#Modified by Kyle Kaplan in 2019 to use the theoretical energy levels from Roueff et al. (2019)

from pylab import *

#J_max = 40 #Maximum J level to save, to cut down on extraneous lines

wave_range = [0.01, 5000.0] #Set wavlelength range in microns
...
file_name = 'roueff_2019_energies.dat'#Name of data file storing energy level data
...
output = open("H2_line_list_calcualted_all.dat", "w") #Save example line list
